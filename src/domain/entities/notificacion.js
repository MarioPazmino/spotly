...
class Notificacion {
  constructor({
    ...
    if (!notificacionId || !emisorId || !receptorId || !mensaje || !tipoNotificacion || !tipoEnvio) {
      throw new Error('Campos obligatorios faltantes: notificacionId, emisorId, receptorId, mensaje, tipoNotificacion, tipoEnvio');
    }
